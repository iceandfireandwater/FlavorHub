...
def retrieve_and_parse_schema_from_graph_for_prompts(graph: Neo4jGraph) -> str:
    ...
    logger.info("retrieve_and_parse_schema_from_graph_for_prompts()---begin")
    logger.info(graph)  # <langchain_neo4j.graphs.neo4j_graph.Neo4jGraph object at 0x7ff4790ae5c0>
    logger.info(schema)
    # Node properties:
    # NutritionProfile {name: STRING, description: STRING, id: STRING}
    # CookingStep {name: STRING, dish_name: STRING, order: INTEGER, instruction: STRING, id: STRING}
    # Ingredient {name: STRING, id: STRING}
    # CookingMethod {name: STRING, id: STRING}
    # HealthBenefit {name: STRING, id: STRING}
    # DishType {name: STRING, id: STRING}
    # Dish {name: STRING, cook_time: STRING, instructions: STRING, id: STRING}
    # Flavor {name: STRING, id: STRING}
    # Relationship properties:
    # HAS_MAIN_INGREDIENT {amount_text: STRING}
    # HAS_STEP {order: INTEGER}
    # HAS_AUX_INGREDIENT {amount_text: STRING}
    # The relationships:
    ...
    # (:Dish)-[:HAS_MAIN_INGREDIENT]->(:Ingredient)
    # (:Dish)-[:HAS_FLAVOR]->(:Flavor)
    # (:Dish)-[:BELONGS_TO_TYPE]->(:DishType)
    # (:Dish)-[:HAS_STEP]->(:CookingStep)
    # (:Dish)-[:HAS_AUX_INGREDIENT]->(:Ingredient)
    ...
    logger.info("retrieve_and_parse_schema_from_graph_for_prompts()---end")
    return schema
